...
Utilicé las siguientes fórmulas:

$$
0 = \sum^{3}_{i=1} {(\beta_i - \overline\beta)} = \sum^{3}_{i=1} \beta_i^\star 
= \beta_1^\star + \beta_2^\star + \beta_3^\star + \beta_4^\star + \beta_5^\star \\
\Rightarrow
\beta_5^\star = -(\beta_1^\star + \beta_2^\star + \beta_3^\star + \beta_4^\star)
$$
